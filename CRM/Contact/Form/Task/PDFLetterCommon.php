...
class CRM_Contact_Form_Task_PDFLetterCommon extends CRM_Core_Form_Task_PDFLetterCommon {
  ...
  public static function buildQuickForm(&$form) {
    $form->addElement('hidden', 'pdf_filename', NULL, ['id' => 'pdf_filename']);
  ...
  private static function getFileName(CRM_Core_Form $form) {
    if (!empty($form->getVar('_submitValues')['pdf_filename'])) {
      $fileName = CRM_Utils_String::munge($form->getVar('_submitValues')['pdf_filename'], '_', 200);
    }
